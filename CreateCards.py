...
GridPackPath='root://cmseos.fnal.gov//store/user/janguian/gridpacks/'+outputName+'_el8_amd64_gcc10_CMSSW_12_4_8_tarball.tar.xz'
...
#ctau = N2ctauStr
fragment = CT.getFragment(GridPackPath, mGo, N2ctau)
